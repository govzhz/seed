...
public class DingTalkUtils {
  ...
  private static final OkHttpWrapper okHttpWrapper = new OkHttpWrapper(DefaultSingleTonOkHttpClient.getInstance());

  final public static String ERR_CODE = "0";
   ...
   * 钉钉群机器人消息
   */
  public static DingTalkResponse sendTextMsg(String url, String content, List<String> atMobiles, boolean isAtAll)
      throws IOException {
  ...
  public static boolean isSuccess(DingTalkResponse dingTalkResponse) {
    ...
    if (StringUtils.equalsIgnoreCase(dingTalkResponse.getErrCode(), ERR_CODE)) {
      return true;
    }
    return false;
  }
